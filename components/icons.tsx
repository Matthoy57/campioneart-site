...
export function BurgerIcon({ size = 22 }: { size?: number }) {
  return (
...
export function BackArrowIcon({ size = 17 }: { size?: number }) {
  return (
...
export function EyeOffIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      <path d="M17.94 17.94A10.9 10.9 0 0 1 12 20c-7 0-11-8-11-8a20.3 20.3 0 0 1 5.06-5.94M9.9 4.24A9.1 9.1 0 0 1 12 4c7 0 11 8 11 8a20.4 20.4 0 0 1-2.68 3.9M14.12 14.12a3 3 0 1 1-4.24-4.24" />
      <path d="M1 1l22 22" />
    </svg>
  );
}
...
export function DiceIcon({ size = 18, pipColor = "#141126" }: { size?: number; pipColor?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24">
      <rect x="2" y="2" width="20" height="20" rx="5" fill="currentColor" />
      <circle cx="8" cy="8" r="1.6" fill={pipColor} />
      <circle cx="16" cy="8" r="1.6" fill={pipColor} />
      <circle cx="8" cy="16" r="1.6" fill={pipColor} />
      <circle cx="16" cy="16" r="1.6" fill={pipColor} />
      <circle cx="12" cy="12" r="1.6" fill={pipColor} />
    </svg>
  );
}
